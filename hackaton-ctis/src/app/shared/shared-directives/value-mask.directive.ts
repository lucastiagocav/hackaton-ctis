...
@Directive({
  ...
  providers: [{
    ...
    useExisting: ValueMaskDirective, 
    multi: true 
  }]
})
export class ValueMaskDirective {
  onTouched: any;
  onChange: any;
  ...
  @Input('valueMask') valueMask: any;

  constructor(private el: ElementRef) {}

  ngOnInit() {
    this.separadorDecimal = this.valueMask.decimal || ',';
    this.separadorMilhar = this.valueMask.milhar || '.';
    this.prefixo = this.valueMask.prefixo || '';
  }
